...
<body class="bg-light">
                        ...
                        <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="filterDropdown">
                            ...
                            <div class="border bg-light p-3 rounded mb-3">
                                <h5 class="d-flex justify-content-between mb-3">
                                    ...
                                    <button id="chk_avail_btn" class="btn btn-sm text-secondary shadow-none d-none" onclick="chk_avail_clear()">Reset</button>
                                </h5>
                            ...
                            <div class="border bg-light p-3 rounded mb-3">
                                <h5 class="d-flex justify-content-between mb-3">
                                    ...
                                    <button id="facilities_btn" class="btn btn-sm text-secondary shadow-none d-none" onclick="facilities_clear()">Reset</button>
                                </h5>
                                <?php
    ...
    <script>
    // ────────────────────────────────────────────────
    //   AJAX Fetch Rooms (must match your backend logic)
    // ────────────────────────────────────────────────
    ...
    // Reset & visibility logic for buttons...
