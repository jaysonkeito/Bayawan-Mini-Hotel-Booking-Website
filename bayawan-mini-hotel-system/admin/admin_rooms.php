<?php // bayawan-mini-hotel-system/admin/admin_rooms.php
            ...
            <div class="col-12 p-4 overflow-hidden">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <nav>
                            <ul class="pagination mt-3" id="rooms-pagination"></ul>
                        </nav>
                    </div>
                </div>
...
<!-- Room Images Modal -->
<div class="modal fade" id="room-images" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
...
<script src="scripts/admin_rooms.js"></script>
