/* bayawan-mini-hotel-system/scripts/admin_csrf.js
 *
 * PLACE THIS FILE AT: bayawan-mini-hotel-system/scripts/admin_csrf.js
 * (same folder as session_timeout.js — NOT inside admin/scripts/)
 *
 * Reads the CSRF token from <meta name="csrf-token"> and automatically
 * injects it into every XHR and fetch() POST made on admin pages.
 * Must be loaded BEFORE any other admin JS scripts.
 */
